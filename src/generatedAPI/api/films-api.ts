...
export const FilmsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getFilmById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Film>>
    > {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getFilms(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const FilmsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getFilms(options?: AxiosRequestConfig): AxiosPromise<Array<Film>> {
      return localVarFp
        .getFilms(options)
        .then((request) => request(axios, basePath));
    },
...
export class FilmsApi extends BaseAPI {
   ...
   * @memberof FilmsApi
   */
  public getFilms(options?: AxiosRequestConfig) {
    return FilmsApiFp(this.configuration)
      .getFilms(options)
      .then((request) => request(this.axios, this.basePath));
  }
